...
*}
<section id="ps_dashboard" class="panel widget">
	<div class="panel-heading">
		<i class="icon-time"></i> {l s='Activity overview' d='Modules.Dashactivity.Admin'}
		<span class="panel-heading-action">
			<a class="list-toolbar-btn" href="#" onclick="toggleDashConfig('ps_dashboard'); return false;" title="{l s='Configure' d='Admin.Actions'}">
				<i class="process-icon-configure"></i>
			</a>
			<a class="list-toolbar-btn" href="#" onclick="refreshDashboard('ps_dashboard'); return false;" title="{l s='Refresh' d='Admin.Actions'}">
	...
	<section id="dash_customers" class="loading">
		...
		<ul class="data_list">
			...
			<li>
				...
				<span class="data_value size_md">
					<span id="total_subscribers"></span>
				</span>
			</li>
		</ul>
	</section>
	<section id="dash_traffic" class="loading">
		...
		<ul class="data_list">
			...
			<li>
				...
				<div id="dash_traffic_chart23" class='chart with-transitions'>
					<svg></svg>
				</div>
			</li>
		</ul>
